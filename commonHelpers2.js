import"./assets/dark-theme-f2fb0814.js";import"./assets/vendor-59c8246b.js";const l="/bookshelf-project-main/assets/symbol-defs-a993dfba.svg#icon-amazon",c="/bookshelf-project-main/assets/symbol-defs-a993dfba.svg#icon-ibooks",d="/bookshelf-project-main/assets/symbol-defs-a993dfba.svg#icon-trash",p="https://books-backend.p.goit.global/books/",o=document.querySelector(".shopping-list-default-div"),h=document.querySelector(".shopping-list-render");async function u(){try{const s=JSON.parse(localStorage.getItem("idBooks"))||[];if(!s||s.length===0){console.log("Масив ID порожній або відсутній.");return}const t=s.map(async e=>{const r=await fetch(`${p}/${e}`);if(!r.ok)throw new Error(`Failed to fetch data for ID: ${e}`);return r.json()}),a=await Promise.all(t);g(a)}catch(s){console.error("Error:",s.message)}}function g(s){if(s.length===0){o.style.display="block";return}const t=s.map(e=>`
    ...
    `).join("");h.insertAdjacentHTML("beforeend",t),s.length===0?o.style.display="block":o.style.display="none",document.querySelectorAll(".delete-btn").forEach(e=>{e.addEventListener("click",()=>{const r=e.getAttribute("data-book-id");f(r);const n=e.closest(".card");n&&n.remove(),i()})})}u();function f(s){const t=JSON.parse(localStorage.getItem("idBooks"))||[];if(!t||t.length===0)return;const a=t.filter(e=>e!==s);localStorage.setItem("idBooks",JSON.stringify(a))}function b(){return document.querySelector(".shopping-list-render").children.length===0}function i(){const s=document.querySelector(".support-ukraine");b()?(o.style.display="block",s.style.display="block"):(o.style.display="none",s.style.display="block")}i();
